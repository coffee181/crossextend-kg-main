...
但当前主线 benchmark 和回归实验，并不是把全部 400 份文档一次性都跑完，而是主要围绕 3 组可复现实验数据：

- `test1`：1 篇文档
- `test2`：3 篇文档，每域 1 篇
- `test3`：9 篇文档，每域 3 篇

这也是仓库里 `data/evidence_records/*.json` 和 `config/persistent/pipeline.test1.yaml / test2.yaml / test3.yaml` 的实际用途。
