...
- `scripts/regression_test1.py` / `test2.py` / `test3.py` -- 规则回归测试
- `scripts/evaluate_attachment_gold.py` -- attachment gold 评估
- `scripts/run_full_preprocess.py` -- 全量 400 文档预处理
- `scripts/run_cnc_preprocess.py` -- CNC+battery 200 文档预处理
...
- `docs/PROJECT_INTRODUCTION_CN.md`
- `REPRODUCIBILITY.md`
...
- 一个已完成 400 文档全量预处理（deepseek-v4-pro，59.4 小时）的完整实验系统

## 协作原则

- 新功能优先进入主线代码，而不是新增一次性脚本
- 新实验优先复用 `cli.py` 与 `scripts/` 现有入口
